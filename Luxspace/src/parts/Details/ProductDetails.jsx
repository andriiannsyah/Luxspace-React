  ...
  return (
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
        ...
        <div className="flex-1 px-4 md:p-6 text-start">
          <h2 className="text-5xl font-semibold">Chair Thatty</h2>
          ...
          <h6 className="text-xl font-semibold mb-4 text-start">About the product</h6>
          <p className="text-xl leading-7 mb-6 text-start">Tailored to a level of perfection synonymous with that of a Savile Row suit and with understated quality in the detail, Jetty has been influenced by timeless 1950s style.</p>
